...
export const registerUser = async (email: string, password: string, organizationName: string) => {
...
export const loginWorker = async (factoryId: string, employeeId: string, password: string) => {
